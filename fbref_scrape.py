...
df_outfield = get_outfield_data('https://fbref.com/en/comps/Big5/','/players/Big-5-European-Leagues-Stats')
print(df_outfield)
df_outfield.to_csv('2021_Outfield.csv', sep='\t')


df_outfield = get_outfield_data('https://fbref.com/en/comps/Big5/2019-2020/','/players/2019-2020-Big-5-European-Leagues-Stats')
print(df_outfield)
df_outfield.to_csv('1920_Outfield.csv', sep='\t')


df_outfield = get_outfield_data('https://fbref.com/en/comps/Big5/2018-2019/','/players/2018-2019-Big-5-European-Leagues-Stats')
print(df_outfield)
df_outfield.to_csv('1819_Outfield.csv', sep='\t')

df_outfield = get_outfield_data('https://fbref.com/en/comps/Big5/2017-2018/','/players/2017-2018-Big-5-European-Leagues-Stats')
print(df_outfield)
df_outfield.to_csv('1718_Outfield.csv', sep='\t')